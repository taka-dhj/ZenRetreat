...
async function addRetreat() {
  try {
    console.log('⚠️  Note: This script requires INSERT permissions.');
    console.log('   If you get a RLS policy error, please run the SQL from ADD_CEBU_RETREAT.md');
    console.log('   in the Supabase Dashboard SQL Editor instead.\n');
    ...
    console.error('\n💡 Solution: Please run the SQL from ADD_CEBU_RETREAT.md');
    console.error('   in the Supabase Dashboard SQL Editor instead.');
    process.exit(1);
  }
}
