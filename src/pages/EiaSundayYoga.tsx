...
const EiaSundayYoga: React.FC = () => {
  ...
  const highlights = [
    { icon: <Leaf size={32} className="text-emerald-600" />,  title: '初心者歓迎のヨガ',    desc: 'ヨガ経験ゼロでも大丈夫。超シンプルな英語のみ使用＆事前に用語集も配布。誰でも安心して参加できます。', bg: 'bg-emerald-50' },
    { icon: <Leaf size={32} className="text-lime-600" />,     title: '有機野菜ランチ',       desc: '地元の有機野菜をたっぷり使ったヘルシーなランチ付き。体の中からもきれいに。', bg: 'bg-lime-50' },
  ...
  return (
    <div className="pt-16 min-h-screen">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute top-0 left-0 right-0 h-1.5 bg-gradient-to-r from-emerald-400 via-teal-300 to-emerald-400" />
        ...
        <div className="relative z-10 text-center px-6 max-w-2xl mx-auto w-full">
          ...
          <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/30 text-white/90 px-5 py-2.5 rounded-full text-sm font-light tracking-wider mb-8">
            <span className="text-emerald-300 font-medium">ZEN RETREAT ASIA</span>
            <span className="text-white/40">×</span>
            <span className="text-teal-300 font-medium">EIA by DAWATA</span>
          </div>
          ...
          <h2 className="text-4xl font-light text-emerald-300 tracking-[0.4em] mb-4">
            EIA
          </h2>
          ...
          <div className="flex justify-center gap-4 mb-12">
            {dates.map((d, i) => (
              <div key={i} className="bg-white/15 backdrop-blur-sm border border-white/30 text-white rounded-2xl px-5 py-3 text-center min-w-[72px]">
                ...
                <div className="text-xs text-emerald-300 mt-1">日曜日</div>
              </div>
            ))}
          </div>
          ...
          <div className="flex flex-col gap-4 mb-8">
            <button
              ...
              className="w-full bg-emerald-500 hover:bg-emerald-400 active:bg-emerald-600 text-white font-bold py-5 px-8 rounded-2xl text-xl shadow-2xl transition-all duration-300 hover:shadow-emerald-500/40"
            >
              今すぐ申し込む ↓
            </button>
            <a
      ...
      <section className="py-16 bg-stone-50">
        <div className="max-w-2xl mx-auto px-6">
          <div className="text-center mb-12">
            <span className="inline-block text-emerald-600 text-xs tracking-widest font-semibold mb-4 uppercase">About This Retreat</span>
            <h2 className="text-3xl font-light text-gray-800 mb-5 leading-snug">
              忙しい日常から一歩下がって、<br />
              <span className="text-emerald-600 font-medium">特別な週末を</span>
            </h2>
            <div className="w-16 h-0.5 bg-emerald-400 mx-auto mb-6" />
      ...
      <section className="py-16 bg-white">
        <div className="max-w-2xl mx-auto px-6">
          <div className="text-center mb-12">
            <span className="inline-block text-emerald-600 text-xs tracking-widest font-semibold mb-4 uppercase">What's Included</span>
      ...
      {/* ======== SCHEDULE ======== */}
      <section id="schedule" className="py-16 bg-gradient-to-br from-emerald-50 to-teal-50">
        <div className="max-w-2xl mx-auto px-6">
          <div className="text-center mb-12">
            <span className="inline-block text-emerald-600 text-xs tracking-widest font-semibold mb-4 uppercase">Schedule</span>
            <h2 className="text-3xl font-light text-gray-800 mb-4">
              当日の<span className="text-emerald-600 font-medium">タイムテーブル</span>
            </h2>
            <div className="w-16 h-0.5 bg-emerald-400 mx-auto mb-5" />
            <div className="inline-flex items-center gap-2 text-gray-700 bg-white px-5 py-2.5 rounded-full border border-emerald-100 shadow-sm text-base">
          ...
          <div className="space-y-3">
            {schedule.map((item, i) => (
              <div key={i} className="bg-white rounded-2xl px-5 py-4 shadow-sm border border-emerald-50 flex items-center gap-4">
                <div className="w-14 flex-shrink-0 text-center">
                  <span className="text-sm font-bold text-emerald-600">{item.time}</span>
                </div>
                <div className="w-px h-8 bg-emerald-100 flex-shrink-0" />
      ...
      <section className="py-16 bg-white">
        <div className="max-w-2xl mx-auto px-6">
          <div className="text-center mb-12">
            <span className="inline-block text-emerald-600 text-xs tracking-widest font-semibold mb-4 uppercase">Venue & Details</span>
            <h2 className="text-3xl font-light text-gray-800 mb-4">
          ...
          <div className="space-y-4">
            {[
              {
                bg: 'bg-emerald-50', borderColor: 'border-emerald-100',
                icon: '📅', label: '開催日程',
                content: <div className="space-y-1">{dates.map((d, i) => <div key={i} className="text-gray-800 font-semibold text-base">{d.full}</div>)}</div>
              },
              {
                bg: 'bg-teal-50', borderColor: 'border-teal-100',
                iconEl: <Clock size={22} className="text-teal-600" />, label: '時間',
              ...
              },
              {
                ...
                icon: '💰', label: '参加費',
                content: <><div className="text-emerald-600 font-bold text-2xl">₱2,000</div><div className="text-gray-500 text-sm mt-0.5">学生割引あり（For Student）</div></>
              },
              {
      ...
      <section className="py-16 bg-stone-50">
        <div className="max-w-2xl mx-auto px-6">
          <div className="text-center mb-10">
            <span className="inline-block text-emerald-600 text-xs tracking-widest font-semibold mb-4 uppercase">Gallery</span>
            <h2 className="text-3xl font-light text-gray-800 mb-4">
      ...
      {/* ======== TESTIMONIALS ======== */}
      <section className="py-16 bg-gradient-to-br from-emerald-700 to-teal-800 relative overflow-hidden">
        <div className="absolute top-0 right-0 w-64 h-64 bg-white/5 rounded-full -translate-y-32 translate-x-32" />
        <div className="absolute bottom-0 left-0 w-48 h-48 bg-white/5 rounded-full translate-y-24 -translate-x-24" />
        <div className="relative max-w-2xl mx-auto px-6">
          <div className="text-center mb-12">
            <span className="inline-block text-emerald-300 text-xs tracking-widest font-semibold mb-4 uppercase">Testimonials</span>
            ...
            {testimonials.map((t, i) => (
              <div key={i} className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-6">
                ...
                <div className="flex items-center gap-3">
                  <div className="w-11 h-11 rounded-full bg-emerald-400/30 flex items-center justify-center text-white font-bold flex-shrink-0">
                    {t.name.charAt(0)}
                  </div>
                  <div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-2xl mx-auto px-6">
          <div className="text-center mb-12">
            <span className="inline-block text-emerald-600 text-xs tracking-widest font-semibold mb-4 uppercase">Upcoming Dates</span>
            <h2 className="text-3xl font-light text-gray-800 mb-4">
            ...
            {dates.map((d, i) => (
              ...
              >
                <div className="flex items-center gap-4 mb-4">
                  <div className="w-16 h-16 rounded-2xl bg-emerald-100 flex flex-col items-center justify-center flex-shrink-0">
                    <span className="text-xs text-emerald-500 font-semibold">{d.month}</span>
                    <span className="text-3xl font-bold text-emerald-700 leading-none">{d.date.split('/')[1]}</span>
                  </div>
                  <div>
                ...
                <button
                  onClick={scrollToForm}
                  className="w-full bg-emerald-500 hover:bg-emerald-600 active:bg-emerald-700 text-white font-bold py-4 rounded-xl transition-all duration-300 text-base"
                >
                  この日程で申し込む
                </button>
              </div>
      ...
      <section className="py-16 bg-stone-50">
        <div className="max-w-2xl mx-auto px-6">
          <div className="text-center mb-12">
            <span className="inline-block text-emerald-600 text-xs tracking-widest font-semibold mb-4 uppercase">FAQ</span>
            <h2 className="text-3xl font-light text-gray-800 mb-4">
            ...
            {faqs.map((faq, i) => (
              <div key={i} className="bg-white rounded-2xl border border-stone-100 overflow-hidden shadow-sm">
                ...
                >
                  ...
                  {openFaq === i
                    ? <ChevronUp size={22} className="text-emerald-500 flex-shrink-0" />
      ...
      <section
        id="apply-form"
        ref={formSectionRef}
        className="py-16 bg-gradient-to-br from-emerald-900 via-teal-900 to-stone-900 relative overflow-hidden"
      >
        <div
        ...
        <div className="relative max-w-2xl mx-auto px-6">
          ...
          <div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
            ...
            <div className="bg-emerald-500 px-5 py-4 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-emerald-100 text-xs mt-0.5">ZEN RETREAT ASIA × EIA by DAWATA</div>
                </div>
              </div>
              <a
            ...
            <div className="relative" style={{ minHeight: '700px' }}>
              {!formLoaded && (
                <div className="absolute inset-0 flex flex-col items-center justify-center bg-stone-50 z-10">
                  <div className="w-14 h-14 border-4 border-emerald-200 border-t-emerald-500 rounded-full animate-spin mb-5" />
            ...
            <div className="bg-stone-50 border-t border-stone-100 px-5 py-5">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-2 bg-emerald-500 hover:bg-emerald-600 active:bg-emerald-700 text-white font-bold py-4 px-6 rounded-xl text-base transition-all duration-300 w-full"
              >
          ...
          <div className="mt-10 text-center space-y-4">
            ...
            <a
              ...
              className="flex items-center justify-center gap-2 text-emerald-300 hover:text-emerald-200 transition-colors text-base"
            >
              <Mail size={18} />
      ...
      <section className="py-6 bg-emerald-600">
        <div className="max-w-2xl mx-auto px-6">
          <div className="flex flex-col items-center gap-3 text-white text-center">
            ...
            <a href="mailto:retreat-eia@zen-retreat-asia.com" className="flex items-center gap-2 hover:text-emerald-200 transition-colors text-sm">
              <Mail size={15} />
              retreat-eia@zen-retreat-asia.com
            </a>
            <a href="tel:+639560831462" className="flex items-center gap-2 hover:text-emerald-200 transition-colors text-sm">
              <Phone size={15} />
              +63 956 083 1462（Taka）
            </a>
          </div>
